...
import pdb
from tensorflow.keras.layers import (Dense, Conv2D, Conv2DTranspose, MaxPool2D, concatenate, ZeroPadding2D)


def U_net(optimizer, activation):
    """
    Parameters:
    ...
    output = Conv2D(4, (1,1), activation = 'sigmoid')(conv_18)
