...
requirement_file_location = path.join(path.dirname(__file__), "requirements.txt")
install_req_objs = parse_requirements(requirement_file_location, session=PipSession())
